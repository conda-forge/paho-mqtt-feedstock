...
Once the `conda-forge` channel has been enabled, `paho-mqtt` can be installed with:

```
conda install paho-mqtt
```

It is possible to list all of the versions of `paho-mqtt` available on your platform with:
